...
public class PlayerHealth : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        EventManager.instance.OnPlayerLowHealth += SoundOnPlayerLowHealth;
    }
    ...
    void Update()
    {
        ...
        if (currentHealth < cirticalHealth)
        {
            EventManager.instance.WhenPlayerLowHealth();
        }
    }
    private void SoundOnPlayerLowHealth()
    {
        AudioManager.instance.StopBGM();
        AudioManager.instance.PlayBGM("O2_Empty");
    }
    ...
    private void OnPlayerHit(int damage)
    {
        ...
        AudioManager.instance.PlaySFX("Hit_Obstacle");
